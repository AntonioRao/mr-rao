...
def test_scrub_email():
    ...
    out, report = apply_privacy_filter(text, PrivacyOptions())
...
def test_scrub_cf():
    ...
    out, report = apply_privacy_filter(
        text,
        PrivacyOptions(emails=False, phones=False, names=False, fiscal=True),
    )
...
def test_scrub_phone_it():
    ...
    out, report = apply_privacy_filter(
        text,
        PrivacyOptions(emails=False, phones=True, names=False, fiscal=False),
    )
    assert "{{PHONE}}" in out
...
def test_italian_name():
    ...
    out, report = apply_privacy_filter(
        text,
        PrivacyOptions(emails=False, phones=False, names=True, fiscal=False),
    )
