...
Lo stato delle voci vale alla **1.25.0**. La fonte di verità resta git e il
...
| P9.2 | **Il nome di battesimo da solo, quando non è anche una parola** | Oggi un nome isolato è un **sospetto**, mai una sostituzione: «Pietro» in un documento resta scritto, e nel rapporto compare la riga «risulta negli elenchi ma non ha nulla intorno che dica che sia una persona».<br><br>**L'idea, che è buona e va misurata prima di essere accolta**: la ragione per cui un nome isolato non si tocca è che «Rosa», «Vera», «Costa», «Villa» sono nomi **e** parole italiane — ma quella ragione non vale per «Walter», «Antonio», «Nazzareno», che parole non sono. Distinguere i due casi ammorbidirebbe il problema per la maggior parte dei nomi senza toccare quelli ambigui.<br><br>**Misurato sugli elenchi**: dei 1017 nomi di battesimo, **891 (l'88%)** superano già i filtri che il motore applica al caso isolato — almeno quattro lettere, non parola comune, non morfologicamente una parola. Quindi la regola coprirebbe quasi tutti i nomi, e ne resterebbero fuori proprio quelli su cui sbaglierebbe.<br><br>**Cosa manca prima di dire di sì, e non è un'opinione.** Il costo di questa regola non si stima leggendo il codice: si misura con i banchi che ci sono già (`scripts/bench_richiamo.py`, il corpus pubblico, `scripts/misura_degrado_reale.py`), contando quante sostituzioni **in più** compaiono sui moduli in bianco. È lo stesso metro che ha fatto ritirare l'euristica del cognome: 8 904 sostituzioni sbagliate su venti moduli. Se il numero è piccolo si accende di serie; se è grande diventa un'opzione.<br><br>**I tre casi da guardare per primi**, perché sono quelli in cui un nome di battesimo compare senza essere una persona: gli **odonimi** («via Vittorio Emanuele», «corso Umberto», «piazza San Marco» — qui sostituire rompe l'indirizzo, che è un dato che il motore tratta già per conto suo), le **intitolazioni** («ospedale Umberto I», «istituto Leonardo da Vinci»), e i **santi** («San Giovanni», «Santa Rita»), dove il nome fa parte di un toponimo.<br><br>**In ogni caso la soglia prosa/modulo va rispettata**: in prosa un riscontro basta già oggi, sul modulo ne servono due. La strada più prudente è accendere la regola **solo in prosa**, che è dove i nomi isolati sono davvero nomi e le etichette di campo non ci sono | Da valutare — misurare prima |
| P9.3 | **Il saluto che annuncia un nome** | «Ciao Pietro», «Caro Marco», «Gentile Anna»: una formula di apertura dichiara che quello che segue è una persona, esattamente come fa una formula di chiusura in `_RE_FIRMA_IT` — che esiste già ed è il posto dove un cognome da solo è davvero un cognome.<br><br>È il pezzo di P9.2 che si può prendere **senza** la misura, perché non allarga il caso isolato: aggiunge un contesto, come il titolo professionale e l'indirizzo di posta. Prezzo basso, e prende il caso più frequente nelle email e nelle chat | Da fare |
