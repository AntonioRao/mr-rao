...
[![Version](https://img.shields.io/badge/version-1.18.1-3b82f6)](docs/CHANGELOG.md)
[![Tests](https://img.shields.io/badge/tests-1038%20passing-10b981)](tests/)
...
Six steps: compilation, importing every module one by one, dependency health, licence alignment, **1038 tests**, published-docs alignment.
