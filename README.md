...
[![Version](https://img.shields.io/badge/version-1.27.4-3b82f6)](docs/CHANGELOG.md)
[![Tests](https://img.shields.io/badge/tests-2271%20passing-10b981)](tests/)
...
Six steps: compilation, importing every module one by one, dependency health, licence alignment, **2271 tests**, published-docs alignment.
