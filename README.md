...
[![Version](https://img.shields.io/badge/version-1.18.2-3b82f6)](docs/CHANGELOG.md)
[![Tests](https://img.shields.io/badge/tests-1040%20passing-10b981)](tests/)
...
Six steps: compilation, importing every module one by one, dependency health, licence alignment, **1040 tests**, published-docs alignment.
