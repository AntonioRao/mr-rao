...
[![Version](https://img.shields.io/badge/version-1.11.0-3b82f6)](docs/CHANGELOG.md)
[![Tests](https://img.shields.io/badge/tests-907%20passing-10b981)](tests/)
...
Six steps: compilation, importing every module one by one, dependency health, licence alignment, **907 tests**, published-docs alignment.
